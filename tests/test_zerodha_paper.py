"""Comprehensive smoke test for paper-trading mode against Zerodha."""
...
spec = importlib.util.spec_from_file_location(
    "fenix.zerodha",
    fenix_path / "fenix" / "zerodha.py"
)
zerodha = importlib.util.module_from_spec(spec)
sys.modules["fenix.zerodha"] = zerodha
spec.loader.exec_module(zerodha)
...
def test_paper_mode():
    """Run 14 comprehensive paper-trading scenarios against Zerodha."""
    ...
    print("\n" + "="*70)
    print("PAPER-TRADING SMOKE TEST - Zerodha (14 scenarios)")
    print("="*70 + "\n")
    ...
    # Test 13: Square-off — Zerodha does not expose square_off_position;
    ...
    try:
        ...
        config_live = {}
        broker_live = Zerodha(config_live)
        try:
